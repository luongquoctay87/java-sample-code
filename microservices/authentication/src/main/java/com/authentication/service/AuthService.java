...
public class AuthService {
    ...
    private String createToken(String tokenType, String subject, String claim) {
        ...
        return JWT.create()
                .withIssuer("issuer") // identifies the party that created the token and signed it
                ...
                .withNotBefore(new Date(System.currentTimeMillis() + 500L)) // identifies the time before which the JWT should not be accepted for processing
                .sign(algorithm);
    }
}
